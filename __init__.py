...
def register(ctx):
    ...
    cmds=[
      ...
      ("cmd-route",c_route,"Explain v1.5.4 routing ownership.","[task]"),
      ...
      ("cmd-help",c_help,"Show v1.5.4 control-plane commands.","")]
    ...
    def pre_llm_call(**kw):
        ...
        if r and r.get("status") not in ("DONE","FAILED","ABORTED"):
            ...
            if stage=="review":
                return {"content":"CMD stage=review. If the user requests edits, apply them with cmd_plan_patch. Before approval, reread the latest .ai/cmd-plans/*_plan.md and reconcile valid human edits without erasing planner comments. If they approve/OK, call cmd_approve_run and execute its returned instruction."}

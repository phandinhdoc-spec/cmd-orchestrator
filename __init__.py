...
def register(ctx):
    ...
    cmds=[
      ...
      ("cmd-route",c_route,"Explain v1.5.1 routing ownership.","[task]"),
      ...
      ("cmd-help",c_help,"Show v1.5.1 control-plane commands.","")]

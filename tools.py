...
"cmd_unit_update":{"name":"cmd_unit_update","description":"Update execution state/evidence for one CMD work_unit executed through Hermes runtime.","parameters":{"type":"object","properties":{"unit_id":{"type":"string"},"status":{"type":"string"},"verification":{"type":"string"},"output_summary":{"type":"string"},"files_touched":{"type":"array","items":{"type":"string"}},"attempts":{"type":"integer"},"error":{"type":"string"},"steps_done":{"type":"array","items":{"type":"string"}},"run_id":{"type":"string"}},"required":["unit_id"]}},
"cmd_complete_run":{"name":"cmd_complete_run","description":"Mark the CMD run complete and enter learning/reflection stage.","parameters":{"type":"object","properties":{"success":{"type":"boolean"},"summary":{"type":"string"},"run_id":{"type":"string"}}}},
...
"cmd_route":{"name":"cmd_route","description":"Compatibility routing preview using CMD role policy plus learning context.","parameters":{"type":"object","properties":{"task":{"type":"string"},"task_class":{"type":"string"},"risk":{"type":"string"}},"required":["task"]}},

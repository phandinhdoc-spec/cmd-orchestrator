...
def orchestrate(request,project="",repository="",mode=None,session_id=""):
    result=begin_prompt_review(request,"",project,repository,session_id)
    return {**result,"owner":"hermes","contract":hermes_plan_contract(),"note":"CMD v1.3.1 is a hierarchical control plane; Hermes orchestrates, strong planner designs, scouts procure reusable components, coders execute contracts."}
